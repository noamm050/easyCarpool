...
public class startTripFromList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start_trip_from_list);
        ...
        call.enqueue(new Callback<List<User>>() {
            ...
            public void onResponse(Call<List<User>> call, Response<List<User>> response) {
                if (!response.isSuccessful()) {
                    Toast.makeText(startTripFromList.this, "EMPTY DATABASE...", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    public void init3() {
        ...
        // Remove TRIP TO A SPECIFIC USER

        RetrofitService retrofitService = new RetrofitService() ;
        UserAPI userAPI = retrofitService.getRetrofit().create(UserAPI.class) ;


        userAPI.userRemoveTrip(tripId,userId /*,user*/)
                .enqueue(new Callback<User>() {
                    @Override
                    public void onResponse(Call<User> call, Response<User> response) {
                        Toast.makeText(startTripFromList.this, "SUCCESS!",Toast.LENGTH_SHORT).show();
                    }
    ...
    public void removePress (View v) {
        init3();
        Intent intent = new Intent(startTripFromList.this, mainPage.class) ;
    ...
    public void startPress(View v) {
        ...
        Intent intent = new Intent(startTripFromList.this,mapActivity.class) ;
        startActivity(intent);
    }
